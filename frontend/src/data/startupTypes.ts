...
export const STARTUP_TYPES: StartupTypeWithKeywords[] = [
  ...
  },
  {
    ...
    desc: "직장 경험에서 쌓은 전문성을 살려 창업으로 전환하려는 유형이에요. 제조·건설처럼 경력 기반 진입장벽이 있는 업종에 유리해요.",
    strength: "경력 기반 전문성",
    caution: "직장인 마인드셋 전환",
    field: "제조·건설·전문서비스",
    industryGroup: "건설업",
  ...
  },
  {
    ...
    name: "재도전형",
    nameEn: "COMEBACK",
    desc: "이전 창업·이직 경험에서 배운 걸 다음 도전에 적용하려는 유형이에요. 회복탄력성이 강점이라 재도전 지원사업이 잘 맞아요.",
    strength: "회복탄력성과 학습 속도",
    caution: "이전 실패 요인 재점검",
    field: "재도전·재창업 전반",
    industryGroup: "전체 업종 평균",
