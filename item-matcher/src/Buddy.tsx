...
const CATEGORIES: Category[] = [
  // ── 하드웨어/딥테크 (구체적 — 최우선) ──
  { re: /반도체|팹리스|파운드리|칩|npu|fpga/i, pri: 10, line: "반도체라니 딥테크네요! 하드웨어·팹리스 특화 지원을 찾아볼게요." },
  { re: /배터리|이차전지|전지/, pri: 10, line: "배터리 분야군요! 소재·에너지 특화 지원을 찾아볼게요." },
  { re: /로봇|로보틱스|드론/, pri: 9, line: "로봇·드론 기술이네요! 딥테크 지원사업을 찾아볼게요." },
  { re: /하드웨어|iot|임베디드|센서|장비|기계/i, pri: 9, line: "하드웨어군요! 시제품 제작·양산 지원 쪽을 눈여겨볼게요." },
  ...
  // ── 콘텐츠/교육 ──
  { re: /게임|메타버스|ar|vr|xr/i, pri: 8, line: "게임·실감콘텐츠군요! 콘텐츠진흥 쪽 지원이 따로 있어요." },
  ...
  { re: /블록체인|웹3|코인|nft/i, pri: 8, line: "웹3 분야군요! 블록체인 특화 지원을 찾아볼게요." },
  ...
  { re: /saas|구독|b2b|솔루션/i, pri: 6, line: "SaaS 비즈니스군요! SW 스타트업 지원사업을 찾아볼게요." },
  { re: /앱|어플|모바일/, pri: 5, line: "앱 서비스군요! 모바일·플랫폼 쪽 지원을 찾아볼게요." },
  { re: /플랫폼|중개|매칭.?서비스/, pri: 5, line: "플랫폼 비즈니스네요! 온라인 서비스 지원을 찾아볼게요." },
  { re: /\bai\b|인공지능|머신러닝|딥러닝|llm|생성형/i, pri: 4, line: "AI 서비스군요.. 이런 쪽으로 특화된 사업지원을 찾아볼게요!" },
  { re: /it|소프트웨어|개발|웹/i, pri: 3, line: "IT 분야군요! SW 창업 지원사업을 찾아볼게요." },
  // ── 대상/단계 (분야가 안 잡힐 때) ──
